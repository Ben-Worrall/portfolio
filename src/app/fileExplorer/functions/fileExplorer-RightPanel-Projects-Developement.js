 ...
 function on_double_4(){
    ...
    return(
        <div id='RightPanel-Portfolio-Subfolders-holder'>
            ...
            <div id='RightPanel-Projects-Subfolders-Developement-SkySurfer-holder'   className='folder-holder' onClick={go_blue_on_2}>
            ...
            <div id='RightPanel-Projects-Subfolders-Developement-Doors98-holder'   className='folder-holder' onClick={go_blue_on_3}>
            ...
            <div id='RightPanel-Projects-Subfolders-Developement-RateTheSkin-holder'   className='folder-holder' onClick={go_blue_on_4}>
